function Sidebar(){
    return <div className="bg-gray-800 h-[calc(100vh-100px)] w-160 m-2 rounded-2xl text-white">
       <div className="p-4">
        ...
        <div className="h-50 overflow-y-scroll">
          <div className="bg-gray-900 p-4 rounded-lg mb-4">
            ...
            <button className="mt-2 px-4 py-2 bg-white text-black rounded-lg">Tạo danh sách phát</button>
          </div>
          ...
          <div className="bg-gray-900 p-4 rounded-lg">
            ...
            <button className="mt-2 px-4 py-2 bg-white text-black rounded-lg">Duyệt xem Podcast</button>
          </div>
        </div>
